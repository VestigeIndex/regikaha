...
export function buildSubscriptionContractSnapshot(input: SubscriptionContractSnapshotInput) {
  ...
  return {
    ...
    clauses: [
      "Regi Kaha no ejecuta obras ni garantiza solicitudes, clientes, ingresos o presupuestos.",
      "La suscripción no compra posiciones ni mejora artificialmente el ranking.",
      "Sin suscripción activa, Regi Kaha puede limitar el acceso comercial sin borrar datos históricos del perfil.",
