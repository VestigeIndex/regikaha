...
export const localSeoDictionaries: Record<Locale, LocalSeoCopy> = {
  es: {
    marketEyebrow: "Cobertura local Regi Kaha", professionalsEyebrow: "Profesionales por localidad", locationType: { city: "Ciudad", town: "Municipio", village: "Pueblo", commune: "Comuna", other: "Localidad" },
