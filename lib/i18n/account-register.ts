...
export const accountRegisterDictionaries: Record<Locale, AccountRegisterCopy> = {
  es: {
    roles: {
      client: { title: "Crear cuenta cliente", text: "Publica proyectos, guarda favoritos, recibe pre-presupuestos y gestiona conversaciones.", submit: "Crear cuenta cliente", terms: "Acepto las condiciones para clientes, la política de privacidad y el uso de RegiKaha como plataforma tecnológica de intermediación." },
      company: { title: "Crear cuenta empresa", text: "Publica necesidades de subcontrata, compara equipos y gestiona solicitudes B2B.", submit: "Crear cuenta empresa", terms: "Acepto las condiciones para empresas, la política de privacidad y el uso de RegiKaha como plataforma tecnológica de intermediación." },
      subcontractor: { title: "Crear cuenta subcontrata", text: "Define especialidades, zonas de servicio y disponibilidad para recibir oportunidades B2B.", submit: "Crear cuenta subcontrata", terms: "Acepto las condiciones para subcontratas, la política de privacidad y el uso de RegiKaha como plataforma tecnológica de intermediación." },
  ...
  it: {
    roles: {
      client: { title: "Crea account cliente", text: "Pubblica progetti, salva preferiti, ricevi stime iniziali e gestisci le conversazioni.", submit: "Crea account cliente", terms: "Accetto le condizioni per i clienti, l’informativa sulla privacy e l’uso di RegiKaha come piattaforma tecnologica di intermediazione." },
      company: { title: "Crea account azienda", text: "Pubblica esigenze di subappalto, confronta squadre e gestisci richieste B2B.", submit: "Crea account azienda", terms: "Accetto le condizioni per le aziende, l’informativa sulla privacy e l’uso di RegiKaha come piattaforma tecnologica di intermediazione." },
      subcontractor: { title: "Crea account subappaltatore", text: "Definisci specialità, aree operative e disponibilità per ricevere opportunità B2B.", submit: "Crea account subappaltatore", terms: "Accetto le condizioni per i subappaltatori, l’informativa sulla privacy e l’uso di RegiKaha come piattaforma tecnologica di intermediazione." },
  ...
  pt: {
    roles: {
      client: { title: "Criar conta de cliente", text: "Publique projetos, guarde favoritos, receba estimativas iniciais e gira conversas.", submit: "Criar conta de cliente", terms: "Aceito as condições aplicáveis a clientes, a política de privacidade e a utilização da RegiKaha como plataforma tecnológica de intermediação." },
      company: { title: "Criar conta de empresa", text: "Publique necessidades de subcontratação, compare equipas e gira pedidos B2B.", submit: "Criar conta de empresa", terms: "Aceito as condições aplicáveis a empresas, a política de privacidade e a utilização da RegiKaha como plataforma tecnológica de intermediação." },
      subcontractor: { title: "Criar conta de subcontratante", text: "Defina especialidades, zonas de serviço e disponibilidade para receber oportunidades B2B.", submit: "Criar conta de subcontratante", terms: "Aceito as condições aplicáveis a subcontratantes, a política de privacidade e a utilização da RegiKaha como plataforma tecnológica de intermediação." },
  ...
  nl: {
    roles: {
      client: { title: "Klantaccount aanmaken", text: "Publiceer projecten, bewaar favorieten, ontvang eerste ramingen en beheer gesprekken.", submit: "Klantaccount aanmaken", terms: "Ik aanvaard de voorwaarden voor klanten, het privacybeleid en het gebruik van RegiKaha als technologisch bemiddelingsplatform." },
      company: { title: "Bedrijfsaccount aanmaken", text: "Publiceer behoeften aan onderaanneming, vergelijk teams en beheer B2B-aanvragen.", submit: "Bedrijfsaccount aanmaken", terms: "Ik aanvaard de voorwaarden voor bedrijven, het privacybeleid en het gebruik van RegiKaha als technologisch bemiddelingsplatform." },
      subcontractor: { title: "Onderaannemersaccount aanmaken", text: "Leg specialismen, werkgebieden en beschikbaarheid vast om B2B-kansen te ontvangen.", submit: "Onderaannemersaccount aanmaken", terms: "Ik aanvaard de voorwaarden voor onderaannemers, het privacybeleid en het gebruik van RegiKaha als technologisch bemiddelingsplatform." },
  ...
  en: {
    roles: {
      client: { title: "Create client account", text: "Publish projects, save favourites, receive initial estimates and manage conversations.", submit: "Create client account", terms: "I accept the terms for clients, the privacy policy and the use of RegiKaha as a technology intermediation platform." },
      company: { title: "Create company account", text: "Publish subcontracting needs, compare teams and manage B2B requests.", submit: "Create company account", terms: "I accept the terms for companies, the privacy policy and the use of RegiKaha as a technology intermediation platform." },
      subcontractor: { title: "Create subcontractor account", text: "Define specialties, service areas and availability to receive B2B opportunities.", submit: "Create subcontractor account", terms: "I accept the terms for subcontractors, the privacy policy and the use of RegiKaha as a technology intermediation platform." },
