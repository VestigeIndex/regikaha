...
const benefits = [
  ...
  { icon: BadgeCheck, title: "Profesionales verificados", text: "Identidad, NIF/CIF y actividad comprobados por RegiNova." },
  ...
  return (
    <>
      <PageHeader
        ...
        description="RegiNova te permite comparar profesionales antes de contratar. Consulta trabajos realizados, precios orientativos, valoraciones reales, especialidades y zona de servicio."
      ...
      <section className="container-x py-16">
        <SectionHeading
          ...
          description="Antes de contratar, compara trabajos realizados, precios orientativos, reseñas y especialidades. RegiNova te ayuda a elegir con más información y menos riesgo."
          align="center"
        />
