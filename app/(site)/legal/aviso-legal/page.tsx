...
export const metadata: Metadata = buildMetadata({
  title: "Aviso legal",
  description: "Aviso legal y condiciones generales de uso del sitio web de Regi Kaha.",
  ...
  return (
    <LegalArticle
      ...
      sections={[
        ...
        { h: "Objeto", p: ["Regi Kaha es un marketplace que conecta a clientes con profesionales verificados de reformas, construcción, instalaciones, mantenimiento, arquitectura e ingeniería. Regi Kaha no presta directamente los servicios de obra; actúa como intermediario tecnológico entre clientes y profesionales."] },
        ...
        { h: "Responsabilidad", p: ["Regi Kaha no se hace responsable de la ejecución de los trabajos contratados entre cliente y profesional, que se rigen por el acuerdo entre ambas partes. Regi Kaha verifica la información de los profesionales en la medida descrita en su política de verificación, pero no garantiza resultados concretos."] },
        { h: "Propiedad intelectual", p: ["Los contenidos, marca, logotipo y diseño del Sitio son titularidad de Regi Kaha o de sus legítimos propietarios. Queda prohibida su reproducción sin autorización."] },
