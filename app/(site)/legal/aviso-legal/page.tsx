...
export const metadata: Metadata = buildMetadata({
  title: "Aviso legal",
  description: "Aviso legal y condiciones generales de uso del sitio web de RegiNova.",
  ...
  return (
    <LegalArticle
      ...
      sections={[
        ...
        { h: "Objeto", p: ["RegiNova es un marketplace que conecta a clientes con profesionales verificados de reformas, construcción, instalaciones, mantenimiento, arquitectura e ingeniería. RegiNova no presta directamente los servicios de obra; actúa como intermediario tecnológico entre clientes y profesionales."] },
        ...
        { h: "Responsabilidad", p: ["RegiNova no se hace responsable de la ejecución de los trabajos contratados entre cliente y profesional, que se rigen por el acuerdo entre ambas partes. RegiNova verifica la información de los profesionales en la medida descrita en su política de verificación, pero no garantiza resultados concretos."] },
        { h: "Propiedad intelectual", p: ["Los contenidos, marca, logotipo y diseño del Sitio son titularidad de RegiNova o de sus legítimos propietarios. Queda prohibida su reproducción sin autorización."] },
