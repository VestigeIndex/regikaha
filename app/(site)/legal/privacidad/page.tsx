  ...
  return (
    <LegalArticle
      ...
      sections={[
        ...
        { h: "Finalidad", p: ["Tratamos los datos para poner en contacto a clientes y profesionales, gestionar las solicitudes de presupuesto, verificar profesionales, gestionar suscripciones y mejorar la plataforma."] },
        ...
        { h: "Destinatarios", p: ["Cuando solicitas presupuesto, tus datos de contacto se comparten con el profesional seleccionado para que pueda responderte. No vendemos tus datos a terceros."] },
