...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Cómo Regi Kaha trata los datos personales de clientes y profesionales conforme al RGPD.",
...
export default function PrivacidadPage() {
  return (
    <LegalArticle
      ...
      intro="En Regi Kaha nos tomamos en serio la protección de tus datos personales, conforme al Reglamento General de Protección de Datos (RGPD) y la normativa española aplicable."
      sections={[
        ...
        { h: "Minimización y destinatarios", p: ["Antes de aceptar una propuesta, Regi Kaha procura limitar la exposición de datos privados: no se muestran públicamente teléfonos, emails, documentos privados ni direcciones exactas. No vendemos tus datos a terceros."] },
