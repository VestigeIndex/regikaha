...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Cómo funcionan las valoraciones verificadas en Regi Kaha. No se compran ni se borran las reseñas legítimas.",
...
export default function PoliticaResenasPage() {
  return (
    <LegalArticle
      ...
      intro="Las valoraciones son uno de los pilares de confianza de Regi Kaha. Esta política explica cómo las gestionamos para que sean justas y verificadas."
      sections={[
        ...
        { h: "Reclamaciones", p: ["Si un profesional considera que una reseña es fraudulenta o difamatoria, puede solicitar su revisión aportando pruebas. El equipo de Regi Kaha valorará cada caso."] },
      ]}
    />
  );
}
