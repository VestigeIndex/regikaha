...
export default function TerminosClientesPage() {
  return (
    <LegalArticle
      ...
      sections={[
        { h: "Uso gratuito", p: ["El uso de RegiKaha como cliente es gratuito: buscar, comparar perfiles, ver portfolios, consultar precios orientativos, publicar proyectos, pedir pre-presupuestos y dejar valoraciones verificadas."] },
        { h: "Relación con el profesional", p: ["RegiKaha actúa como plataforma de conexión entre clientes y profesionales. Los trabajos son realizados por profesionales o empresas independientes. RegiKaha no ejecuta directamente reformas, reparaciones ni instalaciones."] },
        { h: "Pre-presupuestos no vinculantes", p: ["Los pre-presupuestos enviados a través de RegiKaha son estimaciones iniciales no vinculantes. El precio final puede variar según visita técnica, mediciones, materiales, permisos, disponibilidad, urgencia y condiciones reales del trabajo.", "RegiKaha no garantiza la aceptación de una propuesta ni la ejecución final del trabajo. El acuerdo definitivo, el precio final, la garantía, la visita técnica y la ejecución corresponden al cliente y al profesional o empresa contratada."] },
