...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Qué comprueba Regi Kaha antes de mostrar el sello de profesional verificado y qué significan los estados de verificación.",
...
export default function PoliticaVerificacionPage() {
  return (
    <LegalArticle
      ...
      intro="La verificación es lo que distingue a Regi Kaha. Esta política explica qué comprobamos y qué significan los estados de verificación."
      sections={[
        ...
        { h: "Aceptación de normas", p: ["Para verificarse, el profesional acepta las normas del marketplace, incluida la política de reseñas, el ranking por mérito y la prohibición de comprar posiciones."] },
      ]}
    />
  );
}
