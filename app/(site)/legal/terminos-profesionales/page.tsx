...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Condiciones de uso, suscripción y ranking justo de Regi Kaha para profesionales.",
...
export default function TerminosProfesionalesPage() {
  return (
    <LegalArticle
      ...
      intro="Estos términos regulan el alta, la suscripción y el uso de Regi Kaha por parte de los profesionales."
      sections={[
        { h: "Alta y verificación", p: ["Para publicar un perfil, el profesional debe completar el proceso de verificación y aportar información veraz. Regi Kaha puede solicitar documentación adicional y suspender perfiles con datos falsos."] },
        ...
        { h: "Ranking justo", p: ["El orden de aparición se calcula exclusivamente por mérito (valoración, experiencia, proyectos, rapidez de respuesta y verificación). Regi Kaha no vende posiciones ni permite pagar por aparecer primero. Los contactos muestran su precio antes de desbloquearse y no hay comisión sobre el valor del proyecto."] },
        { h: "Pre-presupuestos", p: ["Las respuestas económicas enviadas desde Regi Kaha son pre-presupuestos o estimaciones iniciales no vinculantes, salvo que el profesional y el cliente acuerden expresamente otra cosa fuera de la plataforma. Deben indicar alcance, condiciones, necesidad de visita técnica y factores que pueden modificar el precio final."] },
        ...
        { h: "Valoraciones", p: ["El profesional puede responder a las reseñas. No está permitido comprar reseñas, presionar a clientes ni manipular las valoraciones. Regi Kaha no elimina reseñas legítimas a cambio de pago."] },
        { h: "Suspensión", p: ["Regi Kaha podrá limitar o suspender perfiles que incumplan estos términos, falseen información o perjudiquen la confianza del marketplace."] },
