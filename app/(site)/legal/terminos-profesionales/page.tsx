  ...
  return (
    <LegalArticle
      ...
      sections={[
        ...
        { h: "Suscripción y precios", p: ["El servicio para profesionales tiene una cuota fija de 49,95 €/mes + IVA o 499 €/año + IVA. Los primeros 300 profesionales verificados disfrutan de 5 meses gratis de RegiKaha Pro. No existe permanencia."] },
