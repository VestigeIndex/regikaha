...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Condiciones de uso de RegiKaha para subcontratas, equipos técnicos e instaladores que buscan oportunidades B2B.",
...
export default function SubcontractorTermsPage() {
  return (
    <LegalArticle
      ...
      intro="Estas condiciones aplican a subcontratas, instaladores, equipos técnicos y empresas que ofrecen capacidad operativa a través de RegiKaha."
      sections={[
        ...
        { h: "Limitación por impago o cancelación", p: ["Si la suscripción vence, se cancela o queda impagada, RegiKaha puede limitar la visibilidad y recepción de oportunidades sin eliminar el perfil, portfolio, documentación o reseñas existentes."] },
        { h: "No garantía de contratación", p: ["RegiKaha no garantiza un número mínimo de solicitudes, clientes, ingresos, presupuestos ni contratos B2B. El ranking no se compra y la suscripción no mejora artificialmente posiciones."] },
      ]}
    />
  );
}
