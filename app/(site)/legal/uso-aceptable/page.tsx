...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Normas de uso aceptable de RegiKaha para clientes, profesionales, empresas y subcontratas.",
...
export default function AcceptableUsePage() {
  return (
    <LegalArticle
      ...
      intro="RegiKaha debe ser un entorno fiable para comparar, contactar y gestionar oportunidades reales. Esta política define usos permitidos y prohibidos."
      sections={[
        ...
        { h: "Reseñas y ranking", p: ["No se permite comprar, manipular, coaccionar o inventar reseñas. La suscripción no compra posiciones y RegiKaha puede investigar patrones anómalos."] },
        ...
        { h: "Medidas", p: ["RegiKaha puede limitar, suspender, retirar contenido o solicitar verificación adicional cuando detecte incumplimientos, riesgo para usuarios o señales de fraude."] },
      ]}
    />
  );
}
