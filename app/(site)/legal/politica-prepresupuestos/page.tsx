...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Condiciones de las estimaciones iniciales no vinculantes enviadas en RegiKaha.",
...
export default function PoliticaPrepresupuestosPage() {
  return (
    <LegalArticle
      ...
      intro="Esta política explica cómo funcionan las estimaciones iniciales no vinculantes dentro de RegiKaha."
      sections={[
        ...
        { h: "No ejecución por RegiKaha", p: ["RegiKaha actúa como plataforma de conexión entre clientes y profesionales. Los trabajos son realizados por profesionales o empresas independientes. RegiKaha no ejecuta directamente reformas, reparaciones ni instalaciones."] },
