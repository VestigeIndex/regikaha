...
function styles() {
  return `<style>
    :root{--ink:#0e1a2b;--muted:#66756f;--forest:#1f6fe0;--mint:#d9edff;--canvas:#f7f7f3}
    *{box-sizing:border-box}body{margin:0;font-family:Inter,ui-sans-serif,system-ui,-apple-system,Segoe UI,sans-serif;background:var(--canvas);color:var(--ink)}
    a{color:inherit}.wrap{max-width:1100px;margin:auto;padding:0 20px}.hero{background:linear-gradient(135deg,#11357e,#1f6fe0);color:white;padding:42px 0}.brand{font-weight:800;font-size:20px}.grid{display:grid;grid-template-columns:1fr 340px;gap:24px;align-items:start;margin-top:28px}.card{background:white;border:1px solid #dfe7e2;border-radius:18px;box-shadow:0 18px 40px #0e1a2b14;padding:24px}.h1{font-size:36px;line-height:1.05;margin:12px 0}.muted{color:var(--muted)}.chip{display:inline-flex;border-radius:999px;background:var(--mint);color:#11357e;padding:7px 10px;font-size:13px;font-weight:650}.price{font-size:30px;font-weight:850}.cols{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.box{border-radius:16px;background:#f7f7f3;padding:16px}li{margin:8px 0}.btn{display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:999px;background:var(--forest);color:white;text-decoration:none;font-weight:750;padding:12px 16px;cursor:pointer;width:100%}.input,.textarea{width:100%;border:0;border-radius:13px;background:#f3f5f1;padding:12px;margin-top:6px;font:inherit}.textarea{min-height:96px;resize:vertical}.field{display:block;margin-top:12px;font-size:12px;font-weight:750;text-transform:uppercase;color:var(--muted)}.ok,.err{display:none;margin-top:12px;font-size:14px}.ok{color:#11357e}.err{color:#b42318}
